...
Optimize el nombre de cada variable y su tipo
aunqu een otra carperta estoy intentado optimizar el codigo para  con un wile para que lo repita y no qude tan largo